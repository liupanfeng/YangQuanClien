...
public class BUHomeCommentManagerActivity extends BaseActivity {
    ...
    public void initData() {
        ...
        mTitleList.add("中评");
        mTitleList.add("差评");
        mFragmentList.add(BUHomeGoodsCommentFragment.onInstance(Constants.TYPE_COMMENT_GOOD_TYPE));
        mFragmentList.add(BUHomeGoodsCommentFragment.onInstance(Constants.TYPE_COMMENT_MIDDLE_TYPE));
        mFragmentList.add(BUHomeGoodsCommentFragment.onInstance(Constants.TYPE_COMMENT_BAD_TYPE));
