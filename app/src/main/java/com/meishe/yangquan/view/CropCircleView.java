...
public class CropCircleView extends View {
    ...
    public CropCircleView setRadius(float radius) {
        this.radius = radius;
        post(new Runnable() {
            @Override
            public void run() {
    ...
    public CropCircleView setMaskColor(@ColorInt int maskColor) {
    ...
    public CropCircleView setBorderColor(@ColorInt int borderColor) {
    ...
    public CropCircleView setMaxScale(float maxScale) {
        if(maxScale<1){
            maxScale=1;
        }
    ...
    public CropCircleView setDoubleClickScale(float doubleClickScale) {
    ...
    public CropCircleView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initGesture();
        initAttr(attrs);
    }
    public CropCircleView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initAttr(AttributeSet attrs) {
        ...
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.CropCircleView);
        maskColor = typedArray.getColor(R.styleable.CropCircleView_maskColor, Color.parseColor("#60000000"));
        borderColor = typedArray.getColor(R.styleable.CropCircleView_borderColor, ContextCompat.getColor(getContext(),android.R.color.white));
        radius = typedArray.getDimension(R.styleable.CropCircleView_radius, -1);

        maxScale = typedArray.getFloat(R.styleable.CropCircleView_maxScale, 3f);
        doubleClickScale = typedArray.getFloat(R.styleable.CropCircleView_doubleClickScale, 1.8f);
...
//        showBitmapPaint.setColor(ContextCompat.getColor(getContext(),R.color.black));
    ...
    private void init() {
        ...
        if(showBitmap.getHeight()<getHeight()&&showBitmap.getWidth()<getWidth()){
            ...
            initScale=1;
            initTranslateX=((float) (getWidth()-showBitmap.getWidth()))/2;
            initTranslateY=((float) (getHeight()-showBitmap.getHeight()))/2;
    ...
    public Bitmap clipBitmap(){
        ...
        Bitmap newBitmap = needCropBitmap;
        //需求更改，用户图像显示圆形，但上传的是方形图片
        /*
    ...
    private Bitmap getFlipBitmap(Bitmap newBitmap,int MSCALE_X,int MSCALE_Y){
        ...
        float bitmapWidth = newBitmap.getWidth();
        flipMatrix.postScale(MSCALE_X,MSCALE_Y,bitmapWidth/2,bitmapWidth/2);
        return Bitmap.createBitmap(newBitmap,0,0,newBitmap.getWidth(),newBitmap.getHeight(),flipMatrix,true);
    }
    /*水平翻转*/
    ...
    private RectF getCircleRectFByBitmapRectF(RectF showBitmapRectF){
        ...
        //圆形所在矩阵边长
        float circleRectFLength=rectFW > rectFH ? rectFH : rectFW- Util.dip2px(getContext(),50);
        //计算出圆形所在矩阵的left top
...
/*    private void Log(String s) {
    ...
    @Deprecated
    public CropCircleView setBitmap(Bitmap bitmap){
        showBitmap=bitmap;
        return this;
    }
    /*******************************************************************************************************/
    public CropCircleView setBitmap(int resId, int reqWidth, int reqHeight) {
        showBitmap= CropViewUtils.compressBitmap(getContext(),resId,reqWidth,reqHeight);
        return this;
    }
    public CropCircleView setBitmap(String pathName, int reqWidth, int reqHeight) {
        showBitmap= CropViewUtils.compressBitmap(pathName,reqWidth,reqHeight);
        return this;
    }
    @Deprecated
    public CropCircleView setBitmapToRotate(String pathName, int reqWidth, int reqHeight) {
        //内部已做旋转处理
        showBitmap= CropViewUtils.compressBitmap(pathName,reqWidth,reqHeight);
...
//        }
    ...
    public CropCircleView setBitmap(byte[] data, int offset, int length, int reqWidth, int reqHeight) {
        showBitmap= CropViewUtils.compressBitmap(data,offset,length,reqWidth,reqHeight);
        return this;
    }
    public CropCircleView setBitmap(FileDescriptor fd, Rect outPadding, int reqWidth, int reqHeight) {
        showBitmap= CropViewUtils.compressBitmap(fd,outPadding,reqWidth,reqHeight);
        return this;
    }
    public CropCircleView setBitmap(Resources res, TypedValue value, InputStream is, Rect pad, int reqWidth, int reqHeight) {
        showBitmap= CropViewUtils.compressBitmap(res,value,is,pad,reqWidth,reqHeight);
        return this;
    }
    public CropCircleView setBitmap(InputStream is, Rect outPadding, int reqWidth, int reqHeight) {
    ...
    /*******************************************************************************************************/
    public CropCircleView setBitmapForHeight(int resId, int reqHeight) {
        showBitmap= CropViewUtils.compressBitmapForHeight(getContext(),resId,reqHeight);
        return this;
    }
    public CropCircleView setBitmapForHeight(String pathName, int reqHeight) {
        showBitmap= CropViewUtils.compressBitmapForHeight(pathName,reqHeight);
        return this;
    }
    @Deprecated
    public CropCircleView setBitmapForHeightToRotate(String pathName, int reqHeight) {
        //内部已做旋转处理
        showBitmap= CropViewUtils.compressBitmapForHeight(pathName,reqHeight);
//        int degree = CropViewUtils.readPictureDegree(pathName);
//        if(degree>0){
...
//        }
    ...
    public CropCircleView setBitmapForHeight(byte[] data, int offset, int length, int reqHeight) {
        showBitmap= CropViewUtils.compressBitmapForHeight(data,offset,length,reqHeight);
        return this;
    }
    public CropCircleView setBitmapForHeight(FileDescriptor fd, Rect outPadding, int reqHeight) {
        showBitmap= CropViewUtils.compressBitmapForHeight(fd,outPadding,reqHeight);
        return this;
    }
    public CropCircleView setBitmapForHeight(Resources res, TypedValue value, InputStream is, Rect pad, int reqHeight) {
        showBitmap= CropViewUtils.compressBitmapForHeight(res,value,is,pad,reqHeight);
        return this;
    }
    public CropCircleView setBitmapForHeight(InputStream is, Rect outPadding, int reqHeight) {
    ...
    /*******************************************************************************************************/
    public CropCircleView setBitmapForWidth(int resId, int reqWidth) {
        showBitmap= CropViewUtils.compressBitmapForWidth(getContext(),resId,reqWidth);
        return this;
    }
    public CropCircleView setBitmapForWidth(String pathName, int reqWidth) {
        showBitmap= CropViewUtils.compressBitmapForWidth(pathName,reqWidth);
        return this;
    }
    @Deprecated
    public CropCircleView setBitmapForWidthToRotate(String pathName, int reqWidth) {
        //内部已做旋转处理
        showBitmap= CropViewUtils.compressBitmapForWidth(pathName,reqWidth);
//        int degree = CropViewUtils.readPictureDegree(pathName);
//        if(degree>0){
...
//        }
    ...
    public CropCircleView setBitmapForWidth(byte[] data, int offset, int length, int reqWidth) {
        showBitmap= CropViewUtils.compressBitmapForWidth(data,offset,length,reqWidth);
        return this;
    }
    public CropCircleView setBitmapForWidth(FileDescriptor fd, Rect outPadding, int reqWidth) {
        showBitmap= CropViewUtils.compressBitmapForWidth(fd,outPadding,reqWidth);
        return this;
    }
    public CropCircleView setBitmapForWidth(Resources res, TypedValue value, InputStream is, Rect pad, int reqWidth) {
        showBitmap= CropViewUtils.compressBitmapForWidth(res,value,is,pad,reqWidth);
        return this;
    }
    public CropCircleView setBitmapForWidth(InputStream is, Rect outPadding, int reqWidth) {
    ...
    /*******************************************************************************************************/
    public CropCircleView setBitmapForScale(int resId, int scaleSize) {
        showBitmap= CropViewUtils.compressBitmapForScale(getContext(),resId,scaleSize);
        return this;
    }
    public CropCircleView setBitmapForScale(String pathName, int scaleSize) {
        showBitmap= CropViewUtils.compressBitmapForScale(pathName,scaleSize);
        return this;
    }
    @Deprecated
    public CropCircleView setBitmapForScaleToRotate(String pathName, int scaleSize) {
        //内部已做旋转处理
        showBitmap= CropViewUtils.compressBitmapForScale(pathName,scaleSize);
//        int degree = CropViewUtils.readPictureDegree(pathName);
//        if(degree>0){
...
//        }
    ...
    public CropCircleView setBitmapForScale(byte[] data, int offset, int length, int scaleSize) {
        showBitmap= CropViewUtils.compressBitmapForScale(data,offset,length,scaleSize);
        return this;
    }
    public CropCircleView setBitmapForScale(FileDescriptor fd, Rect outPadding, int scaleSize) {
        showBitmap= CropViewUtils.compressBitmapForScale(fd,outPadding,scaleSize);
        return this;
    }
    public CropCircleView setBitmapForScale(Resources res, TypedValue value, InputStream is, Rect pad, int scaleSize) {
        showBitmap= CropViewUtils.compressBitmapForScale(res,value,is,pad,scaleSize);
        return this;
    }
    public CropCircleView setBitmapForScale(InputStream is, Rect outPadding, int scaleSize) {
