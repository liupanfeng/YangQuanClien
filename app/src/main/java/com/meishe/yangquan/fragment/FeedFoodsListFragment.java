 ...
 */
public class FeedFoodsListFragment extends BaseRecyclerFragment {

    /* 商品类别 ：推荐  综合 销量 价格 */
    private int mFeedType;

    public static FeedFoodsListFragment newInstance(int type) {
        FeedFoodsListFragment feedContentListFragment = new FeedFoodsListFragment();
