 ...
 * 羊五金
 */
public class SellSheepHardwareMessageFragmentList extends BaseRecyclerFragment implements OnResponseListener {
    ...
    public SellSheepHardwareMessageFragmentList() {
    }

    public static SellSheepHardwareMessageFragmentList newInstance(int type) {
        SellSheepHardwareMessageFragmentList fragment = new SellSheepHardwareMessageFragmentList();
