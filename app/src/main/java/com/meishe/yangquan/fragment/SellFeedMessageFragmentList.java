 ...
 * 出售饲料
 */
public class SellFeedMessageFragmentList extends BaseRecyclerFragment implements OnResponseListener {
    ...
    public SellFeedMessageFragmentList() {
    }

    public static SellFeedMessageFragmentList newInstance(int type) {
        SellFeedMessageFragmentList fragment = new SellFeedMessageFragmentList();
