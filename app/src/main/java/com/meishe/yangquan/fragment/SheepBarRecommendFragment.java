...
import static com.meishe.yangquan.utils.Constants.TYPE_LIST_TYPE_RECOMMEND;
 ...
 * @Description : 羊吧推荐页面
 */
public class SheepBarRecommendFragment extends BaseRecyclerFragment {

    @Override
    protected View initView(LayoutInflater inflater, ViewGroup container) {
        View view = inflater.inflate(R.layout.fragment_sheep_bar_recommend, container, false);
    ...
    private void getSheepBarDataFromServer() {
        ...
        param.put("listType", TYPE_LIST_TYPE_RECOMMEND);
        param.put("content", "");
