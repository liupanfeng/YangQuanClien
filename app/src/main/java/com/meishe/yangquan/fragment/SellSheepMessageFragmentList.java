 ...
 *  message list
 */
public class SellSheepMessageFragmentList extends BaseRecyclerFragment implements OnResponseListener {
    ...
    public SellSheepMessageFragmentList() {
    }

    public static SellSheepMessageFragmentList newInstance(int type) {
        SellSheepMessageFragmentList fragment = new SellSheepMessageFragmentList();
