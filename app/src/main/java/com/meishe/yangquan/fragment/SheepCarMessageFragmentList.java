 ...
 * 羊车队伍
 */
public class SheepCarMessageFragmentList extends BaseRecyclerFragment implements OnResponseListener {
    ...
    public SheepCarMessageFragmentList() {
    }

    public static SheepCarMessageFragmentList newInstance(int type) {
        SheepCarMessageFragmentList fragment = new SheepCarMessageFragmentList();
