 ...
 * 购买羊列表
 */
public class BuySheepMessageFragmentList extends BaseRecyclerFragment {
    ...
    public BuySheepMessageFragmentList() {
    }

    public static BuySheepMessageFragmentList newInstance(int type) {
        BuySheepMessageFragmentList fragment = new BuySheepMessageFragmentList();
