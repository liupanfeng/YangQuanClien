 ...
 * 出售兽药
 */
public class SellAnimalDrugsMessageFragmentList extends BaseRecyclerFragment implements OnResponseListener {
    ...
    public SellAnimalDrugsMessageFragmentList() {
    }

    public static SellAnimalDrugsMessageFragmentList newInstance(int type) {
        SellAnimalDrugsMessageFragmentList fragment = new SellAnimalDrugsMessageFragmentList();
