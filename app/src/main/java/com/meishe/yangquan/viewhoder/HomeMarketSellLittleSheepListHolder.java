 ...
 * @author 86188
 */
public class HomeMarketSellLittleSheepListHolder extends BaseViewHolder {
    ...
    public HomeMarketSellLittleSheepListHolder(@NonNull View itemView, BaseRecyclerAdapter adapter) {
        super(itemView);
        mAdapter = adapter;
