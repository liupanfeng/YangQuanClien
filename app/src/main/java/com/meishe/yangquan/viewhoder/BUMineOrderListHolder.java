 ...
 * @author 86188
 */
public class BUMineOrderListHolder extends BaseViewHolder {
    ...
    public BUMineOrderListHolder(@NonNull View itemView, BaseRecyclerAdapter adapter) {
        super(itemView);
        mAdapter = adapter;
...
//            }
            ...
            if (state== Constants.TYPE_ORDER_WAIT_PAY_TYPE){
                ...
                //待评价
                tv_bu_order_right_state.setText("待评价");
                rl_bu_order_wait_pay.setVisibility(View.GONE);
                rl_bu_order_wait_send.setVisibility(View.GONE);
