...
public class HomeServiceListHolder extends BaseViewHolder {
    ...
    /*昵称*/
    private TextView tv_market_nickname;


    public HomeServiceListHolder(@NonNull View itemView, BaseRecyclerAdapter adapter) {
        super(itemView);
        mAdapter = adapter;
    ...
    protected void initViewHolder(View view, Object... obj) {
        tv_market_nickname = view.findViewById(R.id.tv_market_nickname);
...
//            tv_market_price.setText(((ServiceInfo) info).getPrice()+"");
            tv_market_nickname.setText(((ServiceInfo) info).getNickname());
